...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/multi-language-al-folio/es-mx/";
    },
  },{id: "nav-blog",
          title: "blog",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/blog/";
          },
        },{id: "nav-publicações",
          title: "publicações",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/publications/";
          },
        },{id: "nav-projetos",
          title: "projetos",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/projects/";
          },
        },{id: "nav-repositórios",
          title: "repositórios",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/repositories/";
          },
        },{id: "nav-talks",
          title: "Talks",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/talks/";
          },
        },{id: "nav-cv",
          title: "cv",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/cv/";
          },
        },{id: "nav-ensino",
          title: "ensino",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/teaching/";
          },
        },{id: "nav-membros",
          title: "membros",
          ...
          section: "Menu de navegação",
          handler: () => {
            window.location.href = "/multi-language-al-folio/es-mx/people/";
          },
              ...
              handler: () => {
                window.location.href = "/multi-language-al-folio/es-mx/books/";
              },
            },{id: "dropdown-blog",
              title: "blog",
              description: "",
        ...
        handler: () => {
            ...
            window.location.href = "/multi-language-al-folio/es-mx/blog/2026/presernov-dan/";
        ...
        handler: () => {
            ...
            window.location.href = "/multi-language-al-folio/es-mx/blog/2025/tres-ideas-de-colores/";
        ...
        handler: () => {
            ...
            window.location.href = "/multi-language-al-folio/es-mx/blog/2025/three-colourful-ideas/";
        ...
        handler: () => {
            ...
            window.location.href = "/multi-language-al-folio/es-mx/blog/2025/la-vida-como-el-mosh-pit/";
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/books/the_godfather/";
          ...
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2412_chiralExtensions/";
          ...
          description: "",
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2505_largeFixity/";
          ...
          description: "",
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2505_gems/";
          ...
          description: "",
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2508_STM2025/";
          ...
          description: "",
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2509_KSM/";
            },},{id: "news-slovenia-i-am-giving-a-public-talk-in-kranj-slovenia",
          title: ':slovenia: I am giving a public talk in Kranj, Slovenia.',
          description: "",
          section: "Novidades",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/news/2510_kranj/";
            },},{id: "projects-projeto-1",
          title: 'projeto 1',
          description: "com imagem de fundo",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/1_project/";
            },},{id: "projects-projeto-2",
          title: 'projeto 2',
          description: "um projeto com imagem de fundo e comentários do giscus",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/2_project/";
            },},{id: "projects-projeto-3-com-um-nome-bem-longo",
          title: 'projeto 3 com um nome bem longo',
          description: "um projeto que redireciona pra outro website",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/3_project/";
            },},{id: "projects-projeto-4",
          title: 'projeto 4',
          description: "outro sem imagem",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/4_project/";
            },},{id: "projects-projeto-5",
          title: 'projeto 5',
          description: "um projeto com imagem de fundo",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/5_project/";
            },},{id: "projects-projeto-6",
          title: 'projeto 6',
          description: "um projeto sem imagem",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/8_project/";
            },},{id: "projects-project-9",
          title: 'project 9',
          description: "another project with an image 🎉",
          section: "Projetos",handler: () => {
              window.location.href = "/multi-language-al-folio/es-mx/projects/9_project/";
            },},{
        id: 'social-email',
        ...
        handler: () => {
          ...
          section: 'Idiomas',
          handler: () => {
            window.location.href = "/multi-language-al-folio/si" + updatedUrl;
          },
        },{
      id: 'light-theme',
